    ...
    public static class DataProvider
    {
        ...
        public static Ucenik VratiUcenika(string ucenikId)
        {
            ...
            if (ucenikData != null)
            {
                ...
                ucenik.vladanje = ucenikData["vladanje"] != null ? ucenikData["vladanje"].ToString() : string.Empty;
        ...
        public static List<Ucenik> VratiUcenike()
        {
            ...
            foreach (var u in uceniciData)
            {
                ...
                uc.vladanje = u["vladanje"] != null ? u["vladanje"].ToString() : string.Empty;
                ucenici.Add(uc);
            }
        ...
        //vladanje
        public static void DodajUcenika(string ucenikID, string ime, string prezime, string odeljenjeID,string vladanje)
        {
            ISession session = SessionManager.GetSession();
            ...
            RowSet ucenikData = session.Execute("insert into \"Ucenik\" (\"ucenikid\", imeucenik,prezimeucenik,odeljenjeID,vladanje" +
                ")  values ('" + ucenikID + "','" + ime + "','" + prezime + "','" + odeljenjeID + "','"+ vladanje + "')");
        ...
        public static void AzurirajOcenuIzVladanja(string ucenikID, string vladanje)
        {
            ISession session = SessionManager.GetSession();
            ...
            RowSet smerData = session.Execute("update \"Ucenik\" set \"vladanje\" = '" + vladanje + "' where \"ucenikid\" = '" + ucenikID + "'");
        ...
        public static void ObrisiProfesorPredmetOdeljenje(String profID, string predID,string odeljenjeID)
        {
            ISession session = SessionManager.GetSession();
            ProfesorPredmetOdeljenje ppo = new ProfesorPredmetOdeljenje();

            if (session == null)
                return;

            RowSet smerData = session.Execute("delete from \"ProfesorPredmetOdeljenje\" where \"profesorid\" = '" + profID + "' and \"predmetid\" = '" + predID +"' and \"odeljenjeid\" = '" + odeljenjeID +"'");
        }
