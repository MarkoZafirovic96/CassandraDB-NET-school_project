    ...
    public partial class RazredniForm : Form
    {
        ...
        private void btnPrikaziOcene_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                RazredniOceneFormVladanje rf = new RazredniOceneFormVladanje(ucenik);
                rf.ShowDialog();
            }
        ...
        private void Popuni_Formu()
        {
            ...
            {
                ListViewItem item = new ListViewItem(new string[] {  ucenik.imeUcenik, ucenik.prezimeUcenik,ucenik.ucenikID });
                listView1.Items.Add(item);
            }
            listView1.Refresh();
        }

        private void btnPrikaziUcenike_Click(object sender, EventArgs e)
        {
