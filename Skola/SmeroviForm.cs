    ...
    public partial class SmeroviForm : Form
    {
        ...
        private void ucitajFormu()
        {
            ...
            foreach(Smer s in smerovi)
            {
                ...
                ListViewItem item = new ListViewItem(new string[] {  s.nazivSmera,brOd,s.smerID });
        ...
        private void btnDodaj_Click(object sender, EventArgs e)
        {
            ...
            if (sifra == String.Empty || naziv == String.Empty)
            {
            ...
            else
            {
                ...
                ListViewItem item = new ListViewItem(new string[] { naziv, "0", sifra });
                listView1.Items.Add(item);
            }
        }
        ...
        {
            string sifraSmera = listView1.SelectedItems[0].SubItems[2].Text;
        ...
        private void btnPromeni_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selektujte smer koji zelite da promenite");
            }
            else
            {
                ...
                ListViewItem itemNov = new ListViewItem(new string[] { naziv, item.SubItems[1].Text, id });
