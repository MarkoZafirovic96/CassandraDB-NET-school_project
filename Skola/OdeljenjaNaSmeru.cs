...
namespace Skola
{
    public partial class OdeljenjaNaSmeru : Form
    {
        ...
        {
            if (cbxProfesor.SelectedItem == null || txtRazred.Text == "")
            {
                MessageBox.Show("Niste selektovali profesora ili novi razred");
            }
            else
            {
        ...
        {
            if (cbxProfesor.SelectedItem == null)
            {
                MessageBox.Show("Niste selektovali novog razrednog");
            }
            else
            {
                string razred = txtRazred.Text;
