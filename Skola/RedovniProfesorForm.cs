    ...
    public partial class RedovniProfesorForm : Form
    {
        ...
        private void popuni()
        {
            ...
            foreach(Ucenik uc in ucenici)
            {
                ...
                ListViewItem itemp = new ListViewItem(new string[] { uc.imeUcenik,uc.prezimeUcenik,
                    oc.test1,oc.test2,oc.test3,oc.test4,oc.prosek,oc.zakljucnaOcena,uc.ucenikID});
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string id_ucenika = listView1.SelectedItems[0].SubItems[8].Text;
